...
OUTPUT_PREFIX="${OUTPUT_PREFIX:-/root/GSR-lora/save/t5_base_gsr_prefix_svd_12000}"
...
run_variant() {
    ...
    echo "[gsr-prefix-svd] ${tag}: threshold=${THRESHOLD}, energy=${energy}, min_rank=${min_rank}"
